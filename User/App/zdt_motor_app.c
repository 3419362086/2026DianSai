...
void ZDT_Motor_Init(void)
{
    ...
    // Emm_V5_Origin_Modify_Params(MOTOR_X_UART, MOTOR_X_ADDR, true, 0, 0, 10, 10000, 0, 0, 0, MOTOR_SYNC_FLAG);
    // Emm_V5_Origin_Modify_Params(MOTOR_Y_UART, MOTOR_Y_ADDR, true, 0, 0, 10, 10000, 0, 0, 0, MOTOR_SYNC_FLAG);
